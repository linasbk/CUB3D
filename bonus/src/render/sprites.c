...
/*   Updated: 2023/07/21 17:03:43 by lsabik           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		while (x < cub->sp->sp_rightx)
		{
			...
			while(y < cub->sp->sp_bottomy)
			{
				if (x > 0 && x < WIDTH && y > 0 && y < HEIGHT)
				{
					...
					cub->sp->text_y = cub->sp->dist_fromtop * (cub->text[4]->height / cub->sp->sp_height);
						if (sprite.dist < cub->ray_dist[x])
						{
							wall_text = cub->walltexture[4];
							if (((cub->text[4]->width * cub->sp->text_y) + cub->sp->text_x) > 0 && ((cub->text[4]->width * cub->sp->text_y) + cub->sp->text_x) < (cub->text[4]->width * cub->text[4]->height))
							{
							texelcolor = wall_text[(cub->text[4]->width * cub->sp->text_y) + cub->sp->text_x];
						 	if (texelcolor != 0)
